...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> THATCH_STAIRS = registerWithItem("thatch_stairs", () -> new StairBlock(Blocks.HAY_BLOCK.defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.HAY_BLOCK).sound(SoundType.GRASS)));
